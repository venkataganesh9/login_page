...
#Designing a window for registration
def register():
    ...
    Label(register_screen,text="Please enter the details below",bg="pink").pack()
...
def register_user():
    ...
    Label(register_screen, text="Registration Success",fg="blue",font=("calibri", 11)).pack()
